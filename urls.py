...
import app.views as dashboard_views
...
urlpatterns = [
    ...
    # Use views.signup_donor because you imported 'views' on line 18
    path('signup-donor/', views.signup_donor.as_view(), name='signup_donor'),
    #path('signup-donor/', signup_donor.as_view(), name='signup_donor'),
    ...
    path('accepted_donationdetail/<int:pid>/', views.accepted_donationdetail.as_view(), name='accepted_donationdetail'),
    ...
    path('view_volunteerdetail/<int:vid>/', views.view_volunteerdetail.as_view(), name='view_volunteerdetail'),
